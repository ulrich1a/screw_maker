...
iso8676def={
  ...
  '(M12x1.25)':(1.25, 0.3, 16.7, 20.1,  7.5, 0.6,  18.0),
...
class Screw(object):
  ...
  def moveScrew(self, ScrewObj_m):
    ...
    if (mylist.__len__() == 1):
       ...
       if (Axis1 != None):
          ...
          # neuPlatz.move(Pnt1)
          FreeCAD.Console.PrintMessage("die Position in Body    "+ str(neuPlatz) + "\n")
          if self.gotBody:
  ...
  def getDia(self,ThreadType):
    if '(' in ThreadType:
      threadString = ThreadType.lstrip('(M')
      if 'x' in threadString:
        dia = float(threadString.split('x')[0])
      else:
      ...
      if 'x' in threadString:
        ...
        dia=float(threadString.lstrip('M'))
    return dia
